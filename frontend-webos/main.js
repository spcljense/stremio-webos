    ...
    [8792], {
        ...
        289: (e, t, n) => {
            ...
            const m = !0,
                ...
                x = e => {
                    void 0 !== globalThis.webOS && globalThis.webOS.service.request("luna://com.webos.notification", {
                        method: "createToast",
                        parameters: {
                            sourceId: "io.strem.webos",
                            message: e
                        },
                        onSuccess: () => {},
                        onFailure: e => {
                ...
                S = e => ((0, r.Rc)((() => {
                    ...
                    value: {
                        ...
                        version: h,
                        quit: () => {
                            globalThis.webOS ? globalThis.webOS.platformBack() : window.close()
                        },
                        openExternal: ({
                            url: e,
                            payload: t
                        }) => {
                            if (void 0 !== globalThis.webOS) {
